...
if (isset($_GET["id"]) && trim($_GET["id"]) == 'tweet'){
...
$i = 0;
  ...
  while ($arr[$i] !== "..") {
    ...
    $user_pic_id = substr($arr[$i], 19, $num);
    $sql5 = "SELECT * FROM `users` WHERE `users`.`id` = '$user_pic_id';";
    ...
    $dt = $hr.':'.$min.':'.$sec.' '.$date.'-'.$month.'-'.$year;

    echo '<div class="mt-2 container rounded border border-secondary text-light pb-3 pt-3" style="background-color: rgb(47 47 47);">
    <img src="uploads/'.$dp_name.'.jpg" style="width: 50px; height: 50px;" class="rounded-circle border border-light img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt="'.$fname_of.'">
    <span><b><a class="text-light" href="user_page_got.php?username='.$username.'">'.$fname_of.' '.$lname_of.'</a></b></span>
    <a href="thread_film.php" target="_blank"><img src="'.$src.'" class="pt-3 rounded mx-auto d-block" style="width:100%; height:auto;" alt="..."></a>
    <h3 class="text-light mt-2">
    <i class="fas fa-heart pl-4"></i>
    <i class="fa fa-comment pl-4" aria-hidden="true"></i>
    <i class="fa fa-share pl-4" aria-hidden="true"></i></h3>
    <form action="comment_handle.php" method="post">
      <div class="form-group">
      <div class="input-group mb-3">
      <input type="text" class="form-control" placeholder="comment here.." aria-label="Recipient\'s username" aria-describedby="basic-addon2">
      <div class="input-group-append">
        <button type="submit" class="btn btn-outline-light" type="button">Post</button>
      </div>
    </div>
...
<!-- <div class="mt-2 container rounded border border-secondary text-light pb-3" style="background-color: rgb(47 47 47);">
<img src="films/file_2_post_1.jpg" class="rounded mx-auto d-block" style="width:100%; height:auto;" alt="...">
...
<!-- ******************************************************************************* -->
<!-- <div class="mt-2 container rounded border border-secondary text-light pb-3" style="background-color: rgb(47 47 47);">
<img src="films/file_2_post_2.jpg" class="rounded mx-auto d-block" style="width:100%; height:auto;" alt="...">
<p>Hello all nice to meet you :)</p>
<h3 class="text-light mt-2">
<i class="fas fa-heart pl-4"></i>
<i class="fa fa-comment pl-4" aria-hidden="true"></i>
